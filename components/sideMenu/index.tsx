...
import loginStyles from './sideMenu.module.scss';
...
export default function SideMenu() {
  ...
  return (
    <div
      ...
      } d-flex flex-column ${loginStyles['nav-bar']}`}
      id='navBar'
    >
      <ProfileLink />

      <div className={`${loginStyles['menu-container']} d-flex flex-column`}>
        <Link
          name='Dashboard'
          href='/dashboard.html'
        ...
        <Link
          ...
          iconClassName={loginStyles['logout-icon']}
          onClick={() => {
